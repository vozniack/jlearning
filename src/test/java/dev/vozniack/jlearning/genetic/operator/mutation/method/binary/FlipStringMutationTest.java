...
public class FlipStringMutationTest {
    ...
    public void processMutationTest() {
        ...
        GeneticOperator mutation = new FlipStringMutation(1d);
        ...
        assertEquals(oldGenome.length, differences);
    }
    ...
    public void processNoMutationTest() {
        ...
        GeneticOperator mutation = new FlipStringMutation(0d);
        mutation.apply(population);
